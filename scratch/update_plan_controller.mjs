...
export class MobilePlanController {
  ...
  async getAll(
    ...
    try {
      ...
      // Map plans to include action, isTrial, refferalUserFlag, and adjust trialDays to 10 if referral user
...
console.log('Successfully updated MobilePlanController.ts with refferalUserFlag and 10 trial days logic');
